...
contract EventTicketsV2 {
    ...
    */
    ...
    function addEvent(string memory _description, string memory _website, uint numberOfTickets) public onlyOwner returns (uint) {
        ...
        emit LogEventAdded(_description, _website, numberOfTickets, eventId);
    ...
    */
    ...
    function buyTickets(uint eventId, uint numberOfTickets) public payable {
        require(events[eventId].isOpen = true, "ticket sales have closed");
        require(numberOfTickets <= (events[eventId].totalTickets - events[eventId].sales), "not enough tickets available for your order");
        require(msg.value >= (numberOfTickets * PRICE_TICKET), "insufficient funds for tickets");
    ...
    */
    ...
    function getRefund(uint eventId) public payable{
        ...
        events[eventId].sales = (events[eventId].sales - numberOfTickets);
        msg.sender.transfer(numberOfTickets * PRICE_TICKET);
    ...
    */
    ...
    /*
        ...
        TODO:
            ...
            - emit the appropriate event
    */
    function endSale(uint eventId) public onlyOwner payable {
